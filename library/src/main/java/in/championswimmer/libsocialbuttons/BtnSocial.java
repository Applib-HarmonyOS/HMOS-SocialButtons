...
public class BtnSocial extends AppCompatButton {
    ...
    public BtnSocial(Context context, AttributeSet attrs) {
        ...
        System.out.println("ButtonSocial : " + attrs.getAttributeName(0));
        System.out.println("ButtonSocial : " + attrs.getAttributeName(1));
        System.out.println("ButtonSocial : " + attrs.getAttributeName(2));
        System.out.println("ButtonSocial : " + attrs.getAttributeName(3));
        System.out.println("ButtonSocial : " + attrs.getAttributeName(4));
        System.out.println("ButtonSocial : " + attrs.getClassAttribute());
        System.out.println("ButtonSocial : " + attrs.getStyleAttribute());
        System.out.println("ButtonSocial : " + attrs.toString());
        System.out.println("ButtonSocial : " + attrs.getAttributeCount());
        System.out.println("ButtonSocial : " + attrs.getIdAttribute());
